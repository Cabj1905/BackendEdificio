...
import administracion.tpo.exceptions.PersonaException;
import administracion.tpo.exceptions.ReclamoException;
import administracion.tpo.exceptions.UnidadException;
import administracion.tpo.modelo.*;
import administracion.tpo.views.*;
...
public class Controlador {
	...
	public int agregarReclamo(int codigo, String piso, String numero, String documento, String ubicacion, String descripcion,int idtiporeclamo) throws EdificioException, UnidadException, PersonaException {
		Edificio edificio = buscarEdificio(codigo);
		Unidad unidad = buscarUnidad(codigo, piso, numero);
		Persona persona = buscarPersona(documento);
		Reclamo reclamo = new Reclamo(persona, edificio, ubicacion, descripcion, unidad,idtiporeclamo);
		reclamo.save();
